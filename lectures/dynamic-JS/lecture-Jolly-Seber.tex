...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in jags.model("{}JS-spatial.jag"{}, jd1, ji1, n.chains = 1, n.adapt = 5): Unused variable "{}x"{} in data}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jags.model("{}JS-spatial.jag"{}, jd1, ji1, n.chains = 1, n.adapt = 5): RUNTIME ERROR:\\\#\# Compilation error on line 22.\\\#\# Unknown variable X\\\#\# Either supply values for this variable with the data\\\#\# or define it\ \ on the left hand side of a relation.}}\begin{alltt}
\hlstd{jc1} \hlkwb{<-} \hlkwd{coda.samples}\hlstd{(jm1, jp1,} \hlnum{2}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in model\$iter(): JAGS model must be recompiled}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in jags.model("{}JS-spatial-DD.jag"{}, jd2, ji2, n.chains = 1, n.adapt = 2): Unused variable "{}x"{} in data}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jags.model("{}JS-spatial-DD.jag"{}, jd2, ji2, n.chains = 1, n.adapt = 2): RUNTIME ERROR:\\\#\# Compilation error on line 24.\\\#\# Unknown variable X\\\#\# Either supply values for this variable with the data\\\#\# or define it\ \ on the left hand side of a relation.}}\begin{alltt}
\hlstd{jc2} \hlkwb{<-} \hlkwd{coda.samples}\hlstd{(jm2, jp2,} \hlnum{5}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in model\$iter(): JAGS model must be recompiled}}\begin{alltt}
