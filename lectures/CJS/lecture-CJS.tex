...
\hldef{jags.post.samples.nonsp} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}\hlkwc{data}\hldef{=jags.data.nonsp,}
                                      \hlkwc{inits}\hldef{=jags.inits.nonsp,}
                                      \hlkwc{parameters.to.save}\hldef{=jags.pars.nonsp,}
                                      \hlkwc{model.file}\hldef{=}\hlsng{"CJS-nonspatial.jag"}\hldef{,}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{mod} \hlkwb{<-} \hldef{CjsModel}\hlopt{$}\hlkwd{new}\hldef{(}\hlkwd{list}\hldef{(lambda0}\hlopt{~}\hlnum{1}\hldef{, sigma}\hlopt{~}\hlnum{1}\hldef{, phi}\hlopt{~}\hlnum{1}\hldef{), cjs.data,}
                    \hlkwc{start}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{lambda0}\hldef{=}\hlnum{1.5}\hldef{,} \hlkwc{sigma}\hldef{=}\hlnum{50}\hldef{,} \hlkwc{phi}\hldef{=}\hlnum{0.5}\hldef{))}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{jags.post.samples.sp} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}\hlkwc{data}\hldef{=jags.data.sp,}
                                   \hlkwc{inits}\hldef{=jags.inits.sp,}
                                   \hlkwc{parameters.to.save}\hldef{=jags.pars.sp,}
                                   \hlkwc{model.file}\hldef{=}\hlsng{"CJS-spatial.jag"}\hldef{,}
                                   \hlkwc{n.chains}\hldef{=}\hlnum{3}\hldef{,} \hlkwc{n.adapt}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{n.burnin}\hldef{=}\hlnum{0}\hldef{,}
                                   \hlkwc{n.iter}\hldef{=}\hlnum{2000}\hldef{,} \hlkwc{parallel}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{jps.sp.move} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}\hlkwc{data}\hldef{=jd.sp.move,}
                          \hlkwc{inits}\hldef{=ji.sp.move,}
                          \hlkwc{parameters.to.save}\hldef{=}
                              \hlkwd{c}\hldef{(jp.sp.move, jp.s1x, jp.s1y, jp.z1),}
                          \hlkwc{model.file}\hldef{=}\hlsng{"CJS-spatial-move.jag"}\hldef{,}
                          \hlkwc{n.chains}\hldef{=}\hlnum{3}\hldef{,} \hlkwc{n.adapt}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{n.burnin}\hldef{=}\hlnum{0}\hldef{,}
                          \hlkwc{n.iter}\hldef{=}\hlnum{2000}\hldef{,} \hlkwc{parallel}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
