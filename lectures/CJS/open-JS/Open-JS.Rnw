...
\begin{frame}[fragile]
  ...
  \tiny
<<NDR,fig=true,include=false,echo=false>>=
...
<<eval=false,results=hide,keep.source=false>>=
...
<<Ntot,fig=true,include=true,echo=false>>=
...
<<jc1,fig=true,include=false,echo=false>>=
...
\begin{frame}[fragile]
  \frametitle{Posterior distributions}
<<jcN1-4,fig=true,include=false,echo=false>>=
plot(jc1[,c("N[1]", "N[2]", "N[3]", "N[4]")])
@
<<jcN5-8,fig=true,include=false,echo=false>>=
...
\begin{frame}[fragile]
  \frametitle{Density-dependent recruitment}
  \tiny
<<dd1,fig=true,include=false,width=8,height=6,echo=false>>=
N <- 0:50
nu0 <- 2
nu1 <- 0.05
...
\begin{frame}[fragile]
  \frametitle{Time series}
  \tiny
<<NDR-DD,fig=true,include=false,echo=false,width=8,height=6>>=
...
\begin{frame}[fragile]
  \frametitle{Posterior distributions}
<<jc2,fig=true,include=false,echo=false>>=
