...
plot(Predicted ~ temp, gamma.pred, type="l", ylab="Occurrence probability", col="blue",
     xlab="Standardized temperature", ylim=0:1) 
lines(lower ~ temp, gamma.pred, col="grey")
lines(upper ~ temp, gamma.pred, col="grey")
@   
\end{frame}
...
jags.data.covs <- list(y=y, nSites=nSites, elevation=elevation,
