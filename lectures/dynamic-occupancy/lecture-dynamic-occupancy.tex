...
\begin{frame}
  ...
  \end{enumerate}
  \vfill
  \uncover<4->{These probabilities can depend on spatio-temporal
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in summary(jags.post.samples.covs[, jags.pars.covs[1:6]]): internal error -3 in R\_decompress1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': lazy-load database '/home/rchandler/courses/popdy-inference/lectures/dynamic-occupancy/cache/bugs-mcmc-cov\_9e0ce9f958a1d5578d01f61ddc0ca7b6.rdb' is corrupt}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in plot(jags.post.samples.covs[, jags.pars.covs[1:3]]): restarting interrupted promise evaluation}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in plot(jags.post.samples.covs[, jags.pars.covs[1:3]]): internal error -3 in R\_decompress1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': lazy-load database '/home/rchandler/courses/popdy-inference/lectures/dynamic-occupancy/cache/bugs-mcmc-cov\_9e0ce9f958a1d5578d01f61ddc0ca7b6.rdb' is corrupt}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in plot(jags.post.samples.covs[, jags.pars.covs[4:6]]): restarting interrupted promise evaluation}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in plot(jags.post.samples.covs[, jags.pars.covs[4:6]]): internal error -3 in R\_decompress1}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in is.mcmc(x): restarting interrupted promise evaluation}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in is.mcmc(x): internal error -3 in R\_decompress1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.mcmc(x): lazy-load database '/home/rchandler/courses/popdy-inference/lectures/dynamic-occupancy/cache/bugs-mcmc-cov\_9e0ce9f958a1d5578d01f61ddc0ca7b6.rdb' is corrupt}}\begin{alltt}
\hlstd{N.post} \hlkwb{<-} \hlkwd{as.matrix}\hlstd{(jags.post.samples.covs[,N.names])}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in as.matrix(jags.post.samples.covs[, N.names]): restarting interrupted promise evaluation}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in as.matrix(jags.post.samples.covs[, N.names]): internal error -3 in R\_decompress1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.matrix(jags.post.samples.covs[, N.names]): lazy-load database '/home/rchandler/courses/popdy-inference/lectures/dynamic-occupancy/cache/bugs-mcmc-cov\_9e0ce9f958a1d5578d01f61ddc0ca7b6.rdb' is corrupt}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in as.matrix(jags.post.samples.covs[, c("{}beta0.gamma"{}, "{}beta1.gamma"{})]): restarting interrupted promise evaluation}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in as.matrix(jags.post.samples.covs[, c("{}beta0.gamma"{}, "{}beta1.gamma"{})]): internal error -3 in R\_decompress1}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.matrix(jags.post.samples.covs[, c("{}beta0.gamma"{}, "{}beta1.gamma"{})]): lazy-load database '/home/rchandler/courses/popdy-inference/lectures/dynamic-occupancy/cache/bugs-mcmc-cov\_9e0ce9f958a1d5578d01f61ddc0ca7b6.rdb' is corrupt}}\begin{alltt}
