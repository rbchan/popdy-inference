...
## f0 g1 a0 t1 42.6208570 16.7216940 20.3019960 89.4758090
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
## $`N Population Size`
##   estimate       se    lcl      ucl
## 1 96.62086 16.72169 74.302 143.4758
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\begin{verbatim}
##              estimate        se       lcl        ucl fixed note
## pi g1 m1    0.6554420 0.1938702 0.2612441  0.9109757           
## p g1 t1 m1  0.3985716 0.1171102 0.2027866  0.6332368           
## p g1 t1 m2  0.8435083 0.1105443 0.5107924  0.9653087           
## f0 g1 a0 t1 7.6766944 5.7418236 2.0786074 28.3515000
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
## $`N Population Size`
##   estimate       se      lcl      ucl
## 1 94.67669 5.741824 89.07861 115.3515
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\begin{alltt}
\hlkwd{writeLines}\hldef{(}\hlkwd{readLines}\hldef{(}\hlsng{"M0-aug.jag"}\hldef{))}
\end{alltt}
\begin{verbatim}
model {
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.863}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{writeLines}\hldef{(}\hlkwd{readLines}\hldef{(}\hlsng{"Mb-aug.jag"}\hldef{))}
\end{alltt}
\begin{verbatim}
model {
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.863}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{writeLines}\hldef{(}\hlkwd{readLines}\hldef{(}\hlsng{"Mhm-aug.jag"}\hldef{))}
\end{alltt}
\begin{verbatim}
model {
...
\definecolor{shadecolor}{rgb}{0.961, 0.961, 0.863}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{writeLines}\hldef{(}\hlkwd{readLines}\hldef{(}\hlsng{"Mh-aug.jag"}\hldef{))}
\end{alltt}
\begin{verbatim}
model {
