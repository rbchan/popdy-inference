...
## f0 g1 a0 t1 42.6208620 16.7216950 20.3019980 89.4758180
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{yt.ch} \hlkwb{<-} \hlkwd{data.frame}\hldef{(}\hlkwc{ch}\hldef{=}\hlkwd{apply}\hldef{(y.Mt,} \hlnum{1}\hldef{, paste,} \hlkwc{collapse}\hldef{=}\hlsng{""}\hldef{))}
\hldef{mark.Mt} \hlkwb{<-} \hlkwd{mark}\hldef{(}\hlkwc{data}\hldef{=yt.ch,} \hlkwc{model}\hldef{=}\hlsng{"Closed"}\hldef{,} \hlkwc{silent}\hldef{=}\hlnum{TRUE}\hldef{,}
                \hlkwc{model.parameters}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{p}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{formula}\hldef{=}\hlopt{~}\hldef{time,}\hlkwc{share}\hldef{=}\hlnum{TRUE}\hldef{)))}
\end{alltt}
\end{kframe}
\end{knitrout}
\pause
...
\begin{verbatim}
##               estimate        se       lcl        ucl fixed note
## p g1 t1      0.2740198 0.0473865 0.1913594  0.3757931           
## p g1 t2      0.5186804 0.0592722 0.4035760  0.6318356           
## p g1 t3      0.2153013 0.0428690 0.1429995  0.3108977           
...
## $`N Population Size`
##   estimate      se      lcl      ucl
## 1 102.1824 6.44418 93.43883 119.9852
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{yb.ch} \hlkwb{<-} \hlkwd{data.frame}\hldef{(}\hlkwc{ch}\hldef{=}\hlkwd{apply}\hldef{(y.Mb,} \hlnum{1}\hldef{, paste,} \hlkwc{collapse}\hldef{=}\hlsng{""}\hldef{))}
\hldef{mark.Mb} \hlkwb{<-} \hlkwd{mark}\hldef{(}\hlkwc{data}\hldef{=yb.ch,} \hlkwc{model}\hldef{=}\hlsng{"Closed"}\hldef{,} \hlkwc{silent}\hldef{=}\hlnum{TRUE}\hldef{)} \hlcom{## Default model}
\end{alltt}
\end{kframe}
\end{knitrout}
\pause
...
## f0 g1 a0 t1 33.4146740 23.1165900 9.8085735 113.8331100
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
## $`N Population Size`
##   estimate       se      lcl      ucl
## 1 104.4147 23.11659 80.80857 184.8331
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\begin{verbatim}
##              estimate        se       lcl        ucl fixed note
## pi g1 m1    0.6554417 0.1938698 0.2612446  0.9109753           
## p g1 t1 m1  0.3985715 0.1171100 0.2027868  0.6332363           
## p g1 t1 m2  0.8435082 0.1105441 0.5107933  0.9653085           
## f0 g1 a0 t1 7.6766977 5.7418167 2.0786119 28.3514630
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
## $`N Population Size`
##   estimate       se      lcl      ucl
## 1  94.6767 5.741817 89.07861 115.3515
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(jags.post.M0[,jp.M0])}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(jags.post.Mb[,jp.Mb])}
\end{alltt}
\end{kframe}
