...
\hlstd{mark.Mh} \hlkwb{<-} \hlkwd{mark}\hlstd{(}\hlkwc{data}\hlstd{=yh.ch,} \hlkwc{model}\hlstd{=}\hlstr{"HugHet"}\hlstd{,} \hlkwc{silent}\hlstd{=}\hlnum{TRUE}\hlstd{,}
...
\begin{verbatim}
##             estimate        se       lcl       ucl fixed note
## pi g1 m1   0.6178321 0.1887615 0.2522673 0.8856714           
## p g1 t1 m1 0.3654188 0.1276650 0.1636946 0.6288180           
## p g1 t1 m2 0.8227000 0.1059189 0.5278473 0.9506399
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
