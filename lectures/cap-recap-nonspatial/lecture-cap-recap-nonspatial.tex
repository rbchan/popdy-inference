...
\hlstd{mark1} \hlkwb{<-} \hlkwd{mark}\hlstd{(}\hlkwc{data}\hlstd{=y.ch,} \hlkwc{model}\hlstd{=}\hlstr{"Closed"}\hlstd{,} \hlkwc{silent}\hlstd{=}\hlnum{TRUE}\hlstd{,}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mark1}\hlopt{$}\hlstd{results}\hlopt{$}\hlstd{real}
\end{alltt}
\begin{verbatim}
##               estimate         se        lcl        ucl fixed note
## p g1 t1      0.1837077  0.0374009  0.1212906  0.2684329           
## f0 g1 a0 t1 42.6208590 16.7216950 20.3019960 89.4758140
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{mark1}\hlopt{$}\hlstd{results}\hlopt{$}\hlstd{derived}
\end{alltt}
\begin{verbatim}
## $`N Population Size`
##   estimate    lcl      ucl
