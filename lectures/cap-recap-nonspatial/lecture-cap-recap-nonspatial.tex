...
%  \vfill
  ...
  zero'' encounter histories (and thus we don't know $N$). %As a
  %result, the Bernoulli assumption isn't valid.
\end{frame}
...
\begin{verbatim}
##              estimate        se       lcl        ucl fixed note
## pi g1 m1    0.6554418 0.1938704 0.2612437  0.9109758           
## p g1 t1 m1  0.3985716 0.1171103 0.2027864  0.6332368           
## p g1 t1 m2  0.8435083 0.1105444 0.5107921  0.9653087           
## f0 g1 a0 t1 7.6766965 5.7418236 2.0786086 28.3514990
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
\end{knitrout}
  ...
  0$. If the posterior had pushed up against $M$, we would have to
  rerun it with a larger value of $M$.
\end{frame}
