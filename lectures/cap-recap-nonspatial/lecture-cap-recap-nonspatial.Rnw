...
<<build-fun,include=FALSE,eval=FALSE, purl=FALSE>>=
source("../rnw2pdf.R")
...
\vspace{-3pt}
<<bugs-M0-aug,size='footnotesize',comment='',background='beige'>>=
...
\vspace{-3pt}
<<bugs-Mb-aug,size='footnotesize',comment='',background='beige'>>=
...
\begin{frame}[fragile]
  \frametitle{Model $M_h$ -- finite mixture}
\vspace{-3pt}
<<bugs-Mhm-aug,size='footnotesize',comment='',background='beige'>>=
...
\vspace{-3pt}
<<bugs-Mh-aug,size='footnotesize',comment='',background='beige'>>=
