...
It's almost always a good idea to standardize [continuous]{style="color: red;"} covariates.
  
Standardizing involves subtracting the mean and then dividing by the standard deviation.^[You can use the R function `scale` but it's important to know how to do it yourself]
...
<center>
[occupancy-model-covs.jag](occupancy-model-covs.jag)
</center>
...
<center>We'll talk more about design issues later.</center>
