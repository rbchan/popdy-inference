...
\begin{verbatim}
##           [,1]      [,2]      [,3]      [,4]      [,5]
## [1,] 0.5313677 0.5498079 0.5850006 0.6341631 0.6943341
## [2,] 0.1020718 0.1248719 0.2019092 0.2931581 0.3887364
## [3,] 0.8779253 0.7862564 0.6968827 0.6108124 0.5296585
## [4,] 1.0073959 0.9356777 0.8695626 0.8104231 0.7598894
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##          [,1]     [,2]     [,3]     [,4]     [,5]
## [1,] 5.97e-26 1.11e-27 3.76e-31 2.34e-36 2.67e-43
## [2,] 2.49e-02 8.84e-03 5.75e-05 6.86e-09 1.50e-14
## [3,] 2.26e-68 4.03e-55 1.31e-43 7.85e-34 8.59e-26
## [4,] 1.42e-89 1.81e-77 4.20e-67 1.79e-58 1.40e-51
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{## plot(lambda, col=terrain.colors(100),}
\hlcom{##      main="Density surface, activity centers, traps, and capture locs")}
\hlkwd{plot}\hlstd{(}\hlnum{0}\hlstd{,} \hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{),} \hlkwc{ylim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{),} \hlkwc{asp}\hlstd{=}\hlnum{1}\hlstd{,}
