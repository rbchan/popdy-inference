...
<<geo1,size='scriptsize',out.width='0.55\\textwidth',fig.align="center">>=
time <- 0:100         
...
<<geo2,size='tiny',out.width='0.55\\textwidth',fig.align="center">>=
...
\begin{frame}
  \frametitle{\large Geometric growth with stochastic growth rate}
