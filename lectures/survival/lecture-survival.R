...
matplot(0:10, S.post[,1:1000], type="l", xlab="Time", ylab="Survivorship", col=rgb(0,1,1,0.02))
lines(0:10, rowMeans(S.post), col="green", lwd=2)
lines(0:10, phi^(0:10), col="orange", lwd=2)
legend(6, 1, c("Posterior sample", "Posterior mean", "Actual"),
       col=c(rgb(0,1,1,0.2), "green", "orange"), lty=1, lwd=c(1,2,2))
