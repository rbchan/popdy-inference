...
## 
##                     Mean      SD Naive SE Time-series SE
## beta0            1.05773  0.1085 0.001400        0.01167
## beta1            0.55919  0.1220 0.001574        0.01757
## alpha0          -0.07862  0.2254 0.002910        0.02913
## alpha1          -0.98061  0.1910 0.002465        0.03193
## totalAbundance 334.02767 52.8088 0.681758        9.25998
## 
## 2. Quantiles for each variable:
## 
##                    2.5%      25%      50%       75%    97.5%
## beta0            0.8588   0.9818   1.0523   1.12995   1.2853
## beta1            0.3403   0.4719   0.5540   0.63995   0.8060
## alpha0          -0.5355  -0.2330  -0.0745   0.08017   0.3526
## alpha1          -1.3269  -1.1146  -0.9780  -0.85058  -0.6153
## totalAbundance 262.0000 293.0000 323.0000 364.00000 459.0000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
## 
##            Mean     SD Naive SE Time-series SE
## beta0   1.06460 0.1022 0.001319       0.003579
## beta1   0.57118 0.1151 0.001486       0.004762
## alpha0 -0.08476 0.2124 0.002742       0.006952
## alpha1 -1.01045 0.1719 0.002220       0.005931
## 
## 2. Quantiles for each variable:
## 
##           2.5%     25%      50%      75%   97.5%
## beta0   0.8794  0.9946  1.06044  1.13021  1.2742
## beta1   0.3641  0.4908  0.56341  0.64515  0.8094
## alpha0 -0.5054 -0.2250 -0.07878  0.05827  0.3168
## alpha1 -1.3435 -1.1264 -1.01273 -0.89185 -0.6866
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(jags.post.rem4[,jags.pars.rem[}\hlnum{1}\hlopt{:}\hlnum{4}\hlstd{]])}
\end{alltt}
\end{kframe}
...
## 306.1222 237.8064 338.1930 414.2832
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
##    beta0    beta1   alpha0   alpha1 
## 78.56197 44.98987 42.10853 33.81425
\end{verbatim}
\end{kframe}
\end{knitrout}
  Marginalized $N$
...
\begin{verbatim}
##    beta0    beta1   alpha0   alpha1 
## 856.5436 591.6543 933.2527 843.4929
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
