...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{observer} \hlkwb{<-} \hlkwd{matrix}\hldef{(}\hlkwd{c}\hldef{(}\hlsng{"A"}\hldef{,}\hlsng{"B"}\hldef{,}\hlsng{"B"}\hldef{,}\hlsng{"A"}\hldef{),}
                   \hlkwc{nrow}\hldef{=nSites,} \hlkwc{ncol}\hldef{=}\hlnum{2}\hldef{,} \hlkwc{byrow}\hldef{=}\hlnum{TRUE}\hldef{)}
...
\begin{verbatim}
##                   2.5%     25%     50%     75%   97.5%
## deviance       372.892 413.764 436.127 458.540 498.130
## lambda           3.097   3.597   3.955   4.415   5.870
## p1               0.281   0.399   0.460   0.516   0.615
## p2               0.230   0.323   0.374   0.424   0.511
## totalAbundance 319.000 360.000 393.000 438.000 582.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
