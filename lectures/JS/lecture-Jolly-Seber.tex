...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{mark1}\hlopt{$}\hldef{results}\hlopt{$}\hldef{real}
\end{alltt}
\begin{verbatim}
##                      estimate        se       lcl       ucl fixed note
## S g1 c1 a0 t1       0.6218040 0.0402283 0.5403929 0.6968833           
## p g1 s1 t1          0.6544172 0.0241780 0.6056282 0.7001588           
## f0 g1 a0 s1 t0      0.1010123 0.3109896 0.0050080 2.0374188           
## Gamma'' g1 c1 a0 t1 0.0000000 0.0000000 0.0000000 0.0000000 Fixed
\end{verbatim}
\begin{alltt}
\hldef{mark1}\hlopt{$}\hldef{results}\hlopt{$}\hldef{derived}
\end{alltt}
\begin{verbatim}
## $`N Population Size`
##    estimate        se      lcl      ucl
## 1  18.10101 0.3109896 18.00501 20.03742
## 2  21.10101 0.3109896 21.00501 23.03742
## 3  19.10101 0.3109896 19.00501 21.03742
## 4  17.10101 0.3109896 17.00501 19.03742
## 5  17.10101 0.3109896 17.00501 19.03742
## 6  14.10101 0.3109896 14.00501 16.03742
## 7  13.10101 0.3109896 13.00501 15.03742
## 8  14.10101 0.3109896 14.00501 16.03742
## 9  10.10101 0.3109896 10.00501 12.03742
## 10 13.10101 0.3109896 13.00501 15.03742
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
