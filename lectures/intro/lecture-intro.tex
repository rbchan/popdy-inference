...
%\newenvironment{grayoutenv}{\only{\color{gray!10}}}{}
%\newenvironment{grayoutenv}{\only{\setbeamercolor{itemize item}{fg=gray!10}}}{}
\newenvironment{grayoutenv}{
    \only{\color{gray!20}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<6-> Before we even collect our data, we should:
      \begin{itemize}
        \item have hypotheses about processes that are likely to give
