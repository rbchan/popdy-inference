...
- Until recently, population models were mainly used in theoretical settings
  ...
  * Hierarchical models make it possible to learn about ``hidden''
  population dynamics by modeling population processes observed with
  error.
...
## Example I -- Chiricahua Leopard Frog Sites
...
## Example II -- Central Georgia Black Bear Study Design
...
Female-based population model revealed population growth.^[Hooker et al. (2020, Journal of Wildlife Management)]
...
![width=\textwidth]{figs/KeryRoyleBookCoverV2.jpg}
:::
::: {.column width="33%"}
SCR
![](figs/SCRcover.jpeg)
