...
## [Shiny App](https://rbchan-distance-sampling.share.connect.posit.cloud/){#no-margin-slide style="font-size: 70%;"}

<!-- This CSS block only overrides padding while this specific slide is active -->
<!-- <style> -->
...
<iframe src="https://richard-chandler.shinyapps.io/distance-sampling/" width="100%" height="500px" style="border:none;"></iframe>
