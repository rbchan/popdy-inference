...
\hlstd{N3} \hlkwb{<-} \hlkwd{rpois}\hlstd{(}\hlkwc{n}\hlstd{=nSites,} \hlkwc{lambda}\hlstd{=lambda1)}
\end{alltt}
\end{kframe}
\end{knitrout}
  \pause
...
\hlstd{B} \hlkwb{<-} \hlnum{100}                   \hlcom{# plot radius (B)}
...
\hlstd{lambda4} \hlkwb{<-} \hlkwd{exp}\hlstd{(beta0} \hlopt{+} \hlstd{beta1}\hlopt{*}\hlstd{elevation)}
\hlstd{N4} \hlkwb{<-} \hlkwd{rpois}\hlstd{(}\hlkwc{n}\hlstd{=nSites,} \hlkwc{lambda}\hlstd{=lambda4)}
\end{alltt}
\end{kframe}
\end{knitrout}
  \pause
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unmarkedFrameDS(y = y4, siteCovs = data.frame(elevation, noise), : could not find function "{}unmarkedFrameDS"{}}}\end{kframe}
\end{knitrout}
\pause
\begin{knitrout}\tiny
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in summary(umf4): object 'umf4' not found}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in distsamp(\textasciitilde{}noise \textasciitilde{} elevation, umf4, keyfun = "{}halfnorm"{}): could not find function "{}distsamp"{}}}\begin{alltt}
\hlstd{fm4}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'fm4' not found}}\end{kframe}
\end{knitrout}
\pause
\vfill
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in predict(fm4, newdata = pred.data, type = "{}det"{}, append = TRUE): object 'fm4' not found}}\end{kframe}
\end{knitrout}
\pause
\vfill
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(sigma.pred): object 'sigma.pred' not found}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(m\$data, eframe): object 'sigma.pred' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(m\$data, eframe): object 'sigma.pred' not found}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(m\$data, eframe): object 'sigma.pred' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrows(-2, sigma.pred\$Predicted[3], 0.1, 63, len = 0.1, col = "{}blue"{}): object 'sigma.pred' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'sigma.pred' not found}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in par(fig = c(0.5, 0.95, 0.55, 0.95), new = TRUE, las = 1): calling par(new=TRUE) with no plot}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrows(1, sigma.pred\$Predicted[9], 1.1, 55, len = 0.1, col = "{}blue"{}): object 'sigma.pred' not found}}
...
\begin{verbatim}
##                   2.5%     25%      50%      75%    97.5%
## alpha0           2.965   3.028    3.065    3.101    3.169
## alpha1          -0.563  -0.492   -0.457   -0.425   -0.366
## beta0            1.636   1.843    1.946    2.038    2.235
## beta1            0.829   0.960    1.031    1.103    1.252
## deviance       406.460 414.381  418.910  423.628  433.825
## totalAbundance 831.000 978.000 1062.000 1163.000 1354.025
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
