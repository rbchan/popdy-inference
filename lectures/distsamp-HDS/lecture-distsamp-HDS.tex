...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{jags.post.pt} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}\hlkwc{data}\hldef{=jags.data.pt,} \hlkwc{inits}\hldef{=jags.inits.pt,}
                           \hlkwc{parameters.to.save}\hldef{=jags.pars.pt,}
                           \hlkwc{model.file}\hldef{=}\hlsng{"distsamp-point-mod.jag"}\hldef{,}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{round}\hldef{(}\hlkwd{summary}\hldef{(jags.post.pt)}\hlopt{$}\hldef{quantile,} \hlkwc{digits}\hldef{=}\hlnum{3}\hldef{)}
\end{alltt}
\begin{verbatim}
##                    2.5%      25%      50%      75%    97.5%
## alpha0            2.896    2.940    2.963    2.986    3.034
## alpha1           -0.588   -0.546   -0.527   -0.508   -0.473
## beta0             1.830    1.938    1.999    2.056    2.160
## beta1             0.822    0.899    0.945    0.991    1.084
## deviance        645.076  653.169  657.830  662.572  672.513
## totalAbundance 2775.975 3103.000 3276.000 3464.000 3862.025
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\hldef{jags.post.line} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}\hlkwc{data}\hldef{=jags.data.line,} \hlkwc{inits}\hldef{=jags.inits.line,}
                             \hlkwc{parameters.to.save}\hldef{=jags.pars.line,}
                             \hlkwc{model.file}\hldef{=}\hlsng{"distsamp-line-mod.jag"}\hldef{,}
                             \hlkwc{n.chains}\hldef{=}\hlnum{3}\hldef{,} \hlkwc{n.adapt}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{n.burnin}\hldef{=}\hlnum{0}\hldef{,}
                             \hlkwc{n.iter}\hldef{=}\hlnum{2000}\hldef{,} \hlkwc{parallel}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{round}\hldef{(}\hlkwd{summary}\hldef{(jags.post.line)}\hlopt{$}\hldef{quantile,} \hlkwc{digits}\hldef{=}\hlnum{3}\hldef{)}
\end{alltt}
\begin{verbatim}
##                    2.5%      25%      50%      75%    97.5%
## alpha0            2.859    2.905    2.930    2.955    3.000
## alpha1           -0.576   -0.535   -0.514   -0.494   -0.456
## beta0             1.923    2.003    2.044    2.085    2.168
## beta1             0.924    0.987    1.021    1.057    1.118
## deviance        767.462  778.736  784.953  791.727  805.744
## totalAbundance 1925.000 2050.750 2112.000 2178.000 2306.000
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(jags.post.line[,jags.pars.line[}\hlnum{1}\hlopt{:}\hlnum{3}\hldef{]])}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(jags.post.line[,jags.pars.line[}\hlnum{4}\hlopt{:}\hlnum{5}\hldef{]])}
\end{alltt}
\end{kframe}
