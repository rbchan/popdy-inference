...
{\centering \includegraphics[width=0.9\linewidth]{figure/elev-sp-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{figure/utmN-sp-1} 
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/parboot-1} 
