...
\begin{frame}[fragile]
  \frametitle{Spatial prediction}
<<elev-sp,fig.width=9.5,out.width='90%',fig.align='center',size='footnotesize'>>=
library(raster)
...
\begin{frame}[fragile]
  \frametitle{Spatial prediction}
<<utmN-sp,fig.width=9.5,out.width='90%',fig.align='center',size='footnotesize'>>=
utmN <- elev
...
\vfill
<<std-rast>>=
elev.s <- (elev*186.6)+666.1
utmN.s <- (utmN*18030.2)+3852681.2
@
\pause
\vfill
