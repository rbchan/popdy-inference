...
<<secr-elev,size='scriptsize',cache=FALSE>>=
...
\begin{frame}[fragile]
  ...
  individual 1. 
<<fxi,eval=TRUE,size='scriptsize',out.width='70%',fig.align='center'>>=
...
<<mcmc-SCR-elev-sz,size='scriptsize',results='hide',cache=FALSE>>=
...
par(mai=c(0.0,0.0,0.0,0.0))
plot(x, asp=1, xlim=0:1, ylim=0:1, pch=3, axes=FALSE, ann=FALSE)
##MASS::kde2d(s1.post[z.post[,150]==1,150]
