...
\begin{frame}
  \frametitle{\large Closed population model}
  \footnotesize
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{fm.elev} \hlkwb{<-} \hlkwd{secr.fit}\hldef{(sch,} \hlkwc{model}\hldef{=}\hlkwd{list}\hldef{(}\hlkwc{D}\hldef{=}\hlopt{~}\hldef{elevation,} \hlkwc{g0}\hldef{=}\hlopt{~}\hlnum{1}\hldef{,} \hlkwc{sigma}\hldef{=}\hlopt{~}\hlnum{1}\hldef{),}
                    \hlkwc{mask}\hldef{=mask,} \hlkwc{trace}\hldef{=}\hlnum{FALSE}\hldef{)}  \hlcom{## Don't use 'buffer'}
\hlkwd{coef}\hldef{(fm.elev)}
\end{alltt}
\begin{verbatim}
...
## D       log  0.5712491   0.1350596  0.3616658  0.9022848
## g0    logit  0.2354210   0.0384633  0.1684336  0.3188351
## sigma   log 49.8482523   3.2720450 43.8366152 56.6843093
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{fxiContour}\hldef{(fm.elev,} \hlkwc{i}\hldef{=}\hlnum{1}\hldef{)}
\end{alltt}
\end{kframe}
...
## E.N  87.3537   12.228402 66.48162 114.7786 59
## R.N  87.3537    7.885437 75.60648 107.4108 59
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\hldef{jags.post.SCR.elev} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}
    \hlkwc{data}\hldef{=jags.data.SCR.elev,} \hlkwc{inits}\hldef{=ji.SCR.elev,}
    \hlkwc{parameters.to.save}\hldef{=jp.SCR.elev,} \hlkwc{model.file}\hldef{=}\hlsng{"SCR-elev-v2.jag"}\hldef{,}
    \hlkwc{n.chains}\hldef{=}\hlnum{3}\hldef{,} \hlkwc{n.adapt}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{n.iter}\hldef{=}\hlnum{1000}\hldef{,} \hlkwc{parallel}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{frame}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{jags.post.SCR.elev.sz} \hlkwb{<-} \hlkwd{jags.basic}\hldef{(}
    \hlkwc{data}\hldef{=jags.data.SCR.elev,} \hlkwc{inits}\hldef{=ji.SCR.elev,}
    \hlkwc{parameters.to.save}\hldef{=}\hlkwd{c}\hldef{(jp.SCR.elev,}\hlsng{"s"}\hldef{,}\hlsng{"z"}\hldef{),}
    \hlkwc{model.file}\hldef{=}\hlsng{"SCR-elev-v2.jag"}\hldef{,}
    \hlkwc{n.chains}\hldef{=}\hlnum{3}\hldef{,} \hlkwc{n.adapt}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{n.iter}\hldef{=}\hlnum{1000}\hldef{,} \hlkwc{parallel}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
