...
\hlkwd{trellis.par.set}\hlstd{(}\hlkwc{regions}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{col}\hlstd{=}\hlkwd{hcl.colors}\hlstd{(}\hlnum{100}\hlstd{)))} \hlcom{## Colors}
\hlstd{panel1} \hlkwb{<-} \hlkwd{levelplot}\hlstd{(lambda.post.lower} \hlopt{~} \hlstd{x}\hlopt{+}\hlstd{y, elevation.xyz,} \hlkwc{aspect}\hlstd{=}\hlstr{"iso"}\hlstd{,}
                    \hlkwc{at}\hlstd{=}\hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{0.20}\hlstd{,}\hlnum{0.005}\hlstd{),} \hlcom{## Resolution of color key}
                    \hlkwc{colorkey}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{space}\hlstd{=}\hlstr{"bottom"}\hlstd{),}
...
\hlstd{panel2} \hlkwb{<-} \hlkwd{levelplot}\hlstd{(lambda.post.mean} \hlopt{~}\hlstd{x}\hlopt{+}\hlstd{y, elevation.xyz,} \hlkwc{aspect}\hlstd{=}\hlstr{"iso"}\hlstd{,}
                    \hlkwc{at}\hlstd{=}\hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{0.20}\hlstd{,}\hlnum{0.005}\hlstd{))}
...
\hlstd{panels} \hlkwb{<-} \hlkwd{update}\hlstd{(}
    ...
    \hlkwc{xlab}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{""}\hlstd{,}
    \hlkwc{strip}\hlstd{=}\hlkwd{strip.custom}\hlstd{(}\hlkwc{bg}\hlstd{=}\hlkwd{gray}\hlstd{(}\hlnum{0.8}\hlstd{),}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{lambda.r.mean} \hlkwb{<-} \hlkwd{raster}\hlstd{(}\hlkwd{apply}\hlstd{(lambda.r.post,} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{), mean))}
...
\hlkwd{plot}\hlstd{(lambda.re,} \hlkwc{zlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{0.18}\hlstd{))}
\end{alltt}
\end{kframe}
