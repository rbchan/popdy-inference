...
\hlkwd{trellis.par.set}\hlstd{(}\hlkwc{regions}\hlstd{=}\hlkwd{list}\hlstd{(}\hlkwc{col}\hlstd{=}\hlkwd{topo.colors}\hlstd{(}\hlnum{100}\hlstd{)))}
...
\hlcom{##    par.settings=ggplot2like(), #theEconomist.theme(), }
