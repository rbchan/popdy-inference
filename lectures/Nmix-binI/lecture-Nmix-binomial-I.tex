...
\hlkwd{plot}\hldef{(re,} \hlkwc{layout}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{4}\hldef{,}\hlnum{3}\hldef{),} \hlkwc{subset}\hldef{=site}\hlopt{%in%}\hlnum{1}\hlopt{:}\hlnum{12}\hldef{,} \hlkwc{xlim}\hldef{=}\hlkwd{c}\hldef{(}\hlopt{-}\hlnum{1}\hldef{,} \hlnum{11}\hldef{),} \hlkwc{lwd}\hldef{=}\hlnum{5}\hldef{)}
\end{alltt}
\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': incorrect number of dimensions}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': incorrect number of dimensions}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jags.post.samples[, c("{}alpha0"{}, "{}alpha1"{})]: incorrect number of dimensions}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'p.coef.post' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'n.iter' not found}}\end{kframe}
\end{knitrout}
  \pause
  \vfill
...
\begin{verbatim}
##      Length Class Mode   
## [1,] 12000  mcmc  numeric
## [2,] 12000  mcmc  numeric
## [3,] 12000  mcmc  numeric
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in jags.prior.samples[, c("{}alpha0"{}, "{}alpha1"{})]: incorrect number of dimensions}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'n.iter' not found}}\begin{alltt}
\hlkwa{for}\hldef{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{n.iter) \{}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'p.prior.pred' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'p.prior.pred' not found}}\end{kframe}
\end{knitrout}
  \pause
  \vfill
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in polygon(x = c(temp.pred, rev(temp.pred)), y = c(pred.post.lower, : plot.new has not been called yet}}\begin{alltt}
\hlkwd{polygon}\hldef{(}\hlkwc{x}\hldef{=}\hlkwd{c}\hldef{(temp.pred,} \hlkwd{rev}\hldef{(temp.pred)),}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'pred.prior.lower' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'pred.prior.mean' not found}}\begin{alltt}
