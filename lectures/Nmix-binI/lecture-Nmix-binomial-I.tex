...
## deviance       290.0563 15.2478 0.196848        2.11108
...
## deviance       260.9550 279.5994 289.9432 300.30607 320.5036
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(jags.post.samples[,}\hlnum{1}\hlopt{:}\hlnum{2}\hlstd{])}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(jags.post.samples[,}\hlkwd{c}\hlstd{(}\hlnum{3}\hlopt{:}\hlnum{5}\hlstd{,}\hlnum{7}\hlstd{)])}
\end{alltt}
\end{kframe}
