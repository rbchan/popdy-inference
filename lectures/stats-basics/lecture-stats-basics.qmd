...
<center>
![](figure/Rencher_Schaal_book.jpg){height="250"}
![](figure/Hocking_book.jpg){height="250"}
</center>
...
that you fit to your data. A linear model might have dozens of
continuous and categorical predictors variables, with dozens of
associated $\beta$ coefficients. Linear models can also include
