  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item covariate, exposure, etc\dots
        %% \item exposure
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{verbatim}
##           2.5%   25%  50%  75% 97.5%
## beta0    -0.58 -0.15 0.05 0.20  0.61
## beta1    -0.30  0.29 0.53 0.79  1.39
## deviance -2.67 -1.10 0.57 3.67 10.84
## sigmaSq   0.03  0.06 0.08 0.12  0.34
\end{verbatim}
\end{kframe}
\end{knitrout}
\pause
...
%% @
%% \pause
%% {How do we convert logit.p to a probability? \pause Use the
%%   inverse-link: \\}
%% <<inv-logit,size='tiny'>>=
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Simulate logistic regression data according to
      ...
      covariate using \inr{x <- rnorm(n=100)}. Note that you will need
      to use the \inr{rbinom} function to simulate Bernoulli outcomes.
    ...
    %   relationships. 
  \end{enumerate}
  Upload your {\tt .R} or {\tt .Rmd} file to ELC by 5:00 PM Monday.
\end{frame}
